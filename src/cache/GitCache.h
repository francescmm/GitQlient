...
public:
   ...
   GitServer::PullRequest getPullRequestStatus(const QString &sha);
...
private:
   ...
   QMap<QString, GitServer::PullRequest> mPullRequestsStatus;
   ...
   void setPullRequestStatus(QMap<QString, GitServer::PullRequest> prStatus);
};
